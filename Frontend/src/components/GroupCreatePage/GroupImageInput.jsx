...
function validFileName(fileName) {
  const extensionList = ['jpg', 'png', 'jpeg', 'JPG', 'PNG', 'JPEG']
...
function GroupImageInput({ imageMessage, setImageMessage, info, setImage }) {
  const [imageUrl, setImageUrl] = useState(TEMP_IMAGE)
